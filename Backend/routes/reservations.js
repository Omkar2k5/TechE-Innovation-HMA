...
router.get('/', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
...
router.get('/all', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
    const hotelId = req.user.hotelId;
...
router.get('/available-tables', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
    const hotelId = req.user.hotelId;
...
router.post('/', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
    const hotelId = req.user.hotelId;
    const { 
      reservationType, 
...
router.patch('/:id/status', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
...
// Delete reservation
router.delete('/:id', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
    const { id } = req.params;
    const hotelId = req.user.hotelId;
...
router.get('/status/:status', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
    const hotelId = req.user.hotelId;
...
router.get('/type/:type', protect, authorize('admin', 'receptionist', 'manager'), async (req, res) => {
  try {
    const hotelId = req.user.hotelId;
